...
namespace RattleLang {
    ...
    class BasicExpressionCombiner : public DefaultExpressionCombiner {
    public:
        BasicExpressionCombiner(Context *m_context);

        ExpressionCombinerResult combine_statement(const SimpleNode *node, operands operand) override;
