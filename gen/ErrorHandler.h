...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class Rattle;
  class ErrorHandler {
    friend class RattleTokenManager;
    friend class Rattle;
    protected:
      int error_count;
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, Rattle *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, Rattle *parser) {
        error_count++;
      ...
      virtual void handleOtherError(const JJString& message, Rattle *parser) {
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, RattleTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, RattleTokenManager* token_manager) {
...
#endif
/* JavaCC - OriginalChecksum=6c30fce37ebbbaa4d2d43c8e8d56b729 (do not edit this line) */
