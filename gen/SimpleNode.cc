...
SimpleNode::SimpleNode(Rattle *parser, int id) :
     parser(parser), id(id) 
   , BaseASTNode()
{
}
...
void   SimpleNode::jjtSetLastToken(Token* token)  { this->lastToken = token; }
  ...
  /** Accept the visitor. **/
  void  SimpleNode::jjtAccept(RattleVisitor *visitor, void * data) const
{
    return visitor->visit(this, data);
  }

  /** Accept the visitor. **/
void SimpleNode::childrenAccept(RattleVisitor *visitor, void * data) const {
...
/* JavaCC - OriginalChecksum=8abb6f8e50741a480dbd99f5a4461e4f (do not edit this line) */
